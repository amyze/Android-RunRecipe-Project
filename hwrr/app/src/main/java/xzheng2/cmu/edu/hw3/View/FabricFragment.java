 ...
 * {@link FabricFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link FabricFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FabricFragment extends ListFragment {
...
//    private TweetViewAdapter adapter;
     ...
     * @return A new instance of fragment FabricFragment.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_fabric, container, false);
//        adapter = new TweetViewAdapter(getActivity());
//        setListAdapter(adapter);
        final UserTimeline userTimeline = new UserTimeline.Builder()
                .screenName("runnersworld")
                .build();
...
//                        Toast.makeText(TimelineActivity.this, "Failed to retrieve timeline",
